...
export const ORDER_STAGES = ["collected", "processing", "ready", "in_transit", "delivered", "picked_up"] as const;
...
// After Ready the pipeline forks: With Rider (→ Delivered), Delivered, or Picked Up.
export const NEXT_STAGES: Record<OrderStatus, OrderStatus[]> = {
  collected: ["processing"],
  processing: ["ready"],
  ready: ["in_transit", "delivered", "picked_up"],
